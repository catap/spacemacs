...
** Jira support
To bring Jira and OrgMode together over [[https://github.com/ahungry/org-jira][org-jira]] set the variable =org-enable-jira-support= to =t=.
...
If you would like don't enter login/password each time you go to connect,
 you can add to your ~/.authinfo.gpg or ~/.authinfo file, in a format similar to:
...
| ~SPC a o J i b~ | Browse the issue                    |
| ~SPC a o J i g~ | Get issues                          |
| ~SPC a o J i h~ | Get only head of issues             |
| ~SPC a o J i f~ | Get only head of issues from filter |
| ~SPC a o J i F~ | Get issues from filter              |
| ~SPC a o J i u~ | Update the issue                    |
| ~SPC a o J i w~ | Progress the issue                  |
| ~SPC a o J i r~ | Refresh the issue                   |
| ~SPC a o J i c~ | Create the issue                    |
| ~SPC a o J i k~ | Copy current issue key              |
| ~SPC a o J s c~ | Create a subtask                    |
| ~SPC a o J s g~ | Get subtasks                        |
| ~SPC a o J c u~ | Update comment                      |
| ~SPC a o J t j~ | TODO list to jira                   |
